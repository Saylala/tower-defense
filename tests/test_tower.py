...
class TestTower(unittest.TestCase):
    ...
    def test_damage_arcane(self):
        ...
        self.assertEqual(35, test_game.enemies[0].health)
    ...
    def test_damage_guard(self):
        ...
        test_game.place_unit(0, 1, creeps.Peon)
        test_game.field[0][0].attack(test_game)
        self.assertEqual(25, test_game.enemies[0].health)
    ...
    def test_damage_canon(self):
        ...
        test_game.place_unit(0, 1, creeps.Peon)
        test_game.field[0][0].attack(test_game)
        self.assertEqual(15, test_game.enemies[0].health)
    ...
    def test_range_arcane(self):
        ...
        test_game.field[0][0].attack(test_game)
        self.assertEqual(50, test_game.enemies[0].health)
